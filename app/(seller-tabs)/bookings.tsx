...
export default function BookingsScreen() {
  ...
  const TABS = [
    {
      key: "request",
      label: t("bookings.requests"),
      icon: "time-outline",
      count: 3,
    },
    {
      key: "ongoing",
      label: t("bookings.ongoing"),
      ...
      <View style={s.bookingCard}>
        <View style={s.bookingTop}>
          ...
          <View style={[s.statusPill, { backgroundColor: C.greenLight }]}>
            ...
            <Text style={[s.statusText, { color: C.green }]}>
              {t("bookings.active")}
            </Text>
          </View>
        </View>
        <View style={s.progressBlock}>
          <View style={s.progressRow}>
            <Text style={s.progressLabel}>{t("bookings.progress")}</Text>
    ...
    return (
      <View style={s.bookingCard}>
        ...
        <View style={s.completedFooter}>
          <Text style={s.earnedLabel}>{t("bookings.earned")}</Text>
        ...
        <View style={s.strip}>
          {TABS.map((tb) => (
            ...
            >
              ...
              {tab === tb.key && <View style={s.stripActiveLine} />}
            </TouchableOpacity>
          ))}
        </View>
      </View>
              ...
              >
                ...
                {tb.count > 0 && (
                  <View style={[s.tabCount, active && s.tabCountActive]}>
                    <Text
                      style={[s.tabCountText, active && s.tabCountTextActive]}
                    >
                      {tb.count}
                    </Text>
                  </View>
